...
//
//        Supplier walle = new Supplier(000, "Test1", "test2");
//        try {
...
//
////        try {
////            productDataStore.add(new Product(6, amazon,tablets, "Amazon Fire HD 8", "Amazon's latest Fire HD 8 tablet is a great value for media consumption.",
////                    "product_3.jpg",89.99f, "USD"));
////        } catch (SQLException throwables) {
////            throwables.printStackTrace();
////        }
//
